            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="dr_name" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">ເດືອນ/ວັນ/ປີ</label>
                        <input type="date" class="form-control" id="dr_dob" aria-describedby="emailHelp">
                    </div>
                    ...
                    <div class="mb-3">
                        <select class="form-select" aria-label="Default select example" id="qu_id">
                            <option selected value="" hidden>ເລືອກຄິວ</option>
                ...
                <div class="col-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="dr_tel" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
